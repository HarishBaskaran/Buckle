...
import TypeAhead from "smart/pages/hb_components/typeahead";
import { preRequestContext } from "../0_Context/12_PreRequest";
import ProductTable from "smart/pages/hb_components/table";
...
const PopupContent = (props) => {
  ...
  const endpoint = "http://localhost:8080/directory";
  ...
  useEffect(() => {
    if (
      ...
      let array = [];
      array.push(sourceRequest.label);
  ...
  return render ? (
    <>
      <div className="mt-[20px]">
        ...
        <div className="flex flex-col mt-[20px]">
          <div className="flex mx-[20px]">
            <p className="text-gray-500 text-[14px] mt-[5px] mr-[30px]">
              Source Request
            </p>
            <TypeAhead
            ...
            <label className="text-gray-500 text-[14px] mt-[5px] mr-[50px]">
              Source Type
            </label>
            <Dropdown
          ...
          <div className="flex gap-10 mt-[10px] ml-[20px]">
      ...
      <div className="mt-[20px]">
        ...
        <div className="flex flex-col mt-[20px]">
          <div className="flex mx-[20px]">
            <label className="text-gray-500 text-[14px] mt-[8px] mr-[55px]">
              Key Name
            </label>
            <Input
